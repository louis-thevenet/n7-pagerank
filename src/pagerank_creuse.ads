...
package PageRank_Creuse is
    ...
    function Prochaine_Iteration (Poids : PageRank_Result_Inst.T_Tab_Poids; G : in Matrices_Creuses_Inst.T_Matrice; Alpha : Long_Float; Taille : Integer) return PageRank_Result_Inst.T_Tab_Poids;
    ...
    procedure Iterer (Poids : in out PageRank_Result_Inst.T_Tab_Poids; G : in Matrices_Creuses_Inst.T_Matrice; Lignes_Non_Nulles : in T_Vecteur_Creux; K : Integer; Epsilon : Long_Float; Alpha : Long_Float; Taille : Integer)        with
            Pre  => K >= 0;
