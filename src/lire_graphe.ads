...
procedure Completer_Graphe_Creuse (File : in out Ada.Text_IO.File_Type; H : in out Matrices_Creuses.T_Matrice; Lignes_Non_Nulles : in out T_Vecteur_Creux; Taille:Integer);
